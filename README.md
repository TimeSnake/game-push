...
You can optionally replace `<plugins_dir>` with a directory to export the plugin directly.

Run `gradle build` to build it or run `exportAsPlugin` to build and export it to the given folder.
